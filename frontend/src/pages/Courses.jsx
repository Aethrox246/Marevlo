...
const COURSE_TREE = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                description: 'Learn MCP fundamentals, tool integration, and context orchestration patterns for modern AI applications.',
                icon: ServerCog,
    ...
    // { id: 'dsa', label: 'Data Structures & Algorithms', ... }
    {
        ...
        children: [
            ...
            {
                id: 'ds-static-propability',
                label: 'Static & Propability',
                description: 'Build strong fundamentals in statistics and probability for data-driven reasoning, inference, and modeling.',
                icon: FlaskConical,
                gradient: 'linear-gradient(135deg, #14b8a6, #3b82f6)',
                lineGradient: 'from-teal-500 via-cyan-500 to-blue-500',
                tag: 'Core',
                tagColor: '#14b8a6',
                isLeaf: true,
                duration: '8h',
            ...
            },
            {
                ...
                tagColor: '#8b5cf6',
                children: [
                    { id: 'dl-preliminaries', label: 'Preliminaries', description: 'Foundational mathematics and concepts for deep learning — linear algebra, calculus, and probability.', icon: BookOpen, isLeaf: true, duration: '3h', level: 'Beginner', lineGradient: 'from-indigo-500 to-violet-500', gradient: 'linear-gradient(135deg,#6366f1,#8b5cf6)' },
                    { id: 'dl-perceptron', label: 'Perceptron & Feed Forward Networks', description: 'From basic perceptrons to multi-layer neural networks — architecture, activation functions, and backpropagation.', icon: Network, isLeaf: true, duration: '2h 30m', level: 'Beginner', lineGradient: 'from-violet-500 to-pink-500', gradient: 'linear-gradient(135deg,#8b5cf6,#ec4899)' },
                    { id: 'dl-rnn', label: 'Recurrent Neural Networks', description: 'Sequence learning with RNNs, LSTMs, and GRUs — understanding temporal dependencies and handling sequences.', icon: ScanText, isLeaf: true, duration: '2h 45m', level: 'Intermediate', lineGradient: 'from-pink-500 to-rose-500', gradient: 'linear-gradient(135deg,#ec4899,#f43f5e)' },
                    { id: 'dl-attention', label: 'Attention Transformers', description: 'Master the transformer architecture — self-attention mechanisms, multi-head attention, and modern NLP models.', icon: Sparkles, isLeaf: true, duration: '3h 15m', level: 'Intermediate', lineGradient: 'from-rose-500 to-orange-500', gradient: 'linear-gradient(135deg,#f43f5e,#f97316)' },
                    { id: 'dl-gan', label: 'Generative Adversarial Networks', description: 'Build generative models with GANs — generator-discriminator dynamics, training techniques, and applications.', icon: Zap, isLeaf: true, duration: '2h 30m', level: 'Advanced', lineGradient: 'from-orange-500 to-amber-500', gradient: 'linear-gradient(135deg,#f97316,#f59e0b)' },
                    { id: 'dl-linear-reg', label: 'Linear Regression & Deep Learning', description: 'Connect classical regression to deep learning — from linear models to neural architectures for prediction tasks.', icon: GitBranch, isLeaf: true, duration: '2h', level: 'Intermediate', lineGradient: 'from-amber-500 to-emerald-500', gradient: 'linear-gradient(135deg,#f59e0b,#10b981)' },
                    { id: 'dl-gaussian', label: 'Gaussian Processes', description: 'Bayesian non-parametric models — GP fundamentals, kernel methods, and probabilistic inference in deep learning.', icon: FlaskConical, isLeaf: true, duration: '2h 45m', level: 'Advanced', lineGradient: 'from-emerald-500 to-cyan-500', gradient: 'linear-gradient(135deg,#10b981,#06b6d4)' },
                    { id: 'dl-comp-perf', label: 'Computational Performance', description: 'Optimize deep learning for speed and memory — GPU utilization, batching strategies, and inference optimization.', icon: Cpu, isLeaf: true, duration: '2h', level: 'Advanced', lineGradient: 'from-cyan-500 to-blue-500', gradient: 'linear-gradient(135deg,#06b6d4,#3b82f6)' },
                    { id: 'dl-opt-techniques', label: 'Optimization Techniques', description: 'Advanced training optimization — learning rate scheduling, adaptive optimizers, and regularization methods.', icon: Zap, isLeaf: true, duration: '2h 30m', level: 'Advanced', lineGradient: 'from-blue-500 to-indigo-500', gradient: 'linear-gradient(135deg,#3b82f6,#6366f1)' },
                    { id: 'dl-classification', label: 'Classification', description: 'Deep learning for classification tasks — binary, multi-class, and multi-label classification with neural networks.', icon: GitBranch, isLeaf: true, duration: '2h 15m', level: 'Intermediate', lineGradient: 'from-indigo-500 to-purple-500', gradient: 'linear-gradient(135deg,#6366f1,#a855f7)' },
                    { id: 'dl-cv-blog', label: 'Computer Vision Blog', description: 'Insights and tutorials on computer vision applications — image classification, object detection, and segmentation.', icon: Image, isLeaf: true, duration: '1h 30m', level: 'Intermediate', lineGradient: 'from-purple-500 to-pink-500', gradient: 'linear-gradient(135deg,#a855f7,#ec4899)' },
                    { id: 'dl-builder-guide', label: 'Builder Guide', description: 'Practical guide to building end-to-end deep learning projects — from data preparation to production deployment.', icon: Code2, isLeaf: true, duration: '3h', level: 'Advanced', lineGradient: 'from-pink-500 to-rose-500', gradient: 'linear-gradient(135deg,#ec4899,#f43f5e)' },
                    { id: 'dl-ml-blog', label: 'Machine Learning Blog', description: 'Articles and case studies on machine learning trends — deep learning applications, best practices, and research insights.', icon: FileText, isLeaf: true, duration: '1h 45m', level: 'Intermediate', lineGradient: 'from-rose-500 to-orange-500', gradient: 'linear-gradient(135deg,#f43f5e,#f97316)' },
                ],
            },
        ],
    },
