            ...
            <div className="overflow-y-auto h-full" style={{ backgroundColor: 'var(--color-app-bg)', color: 'var(--color-primary-text)' }}>
                <div style={{ maxWidth: '1160px', margin: '0 auto', padding: '64px 24px 96px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: '24px' }}>
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                color: 'rgba(99,102,241,0.05)', letterSpacing: '-0.06em',
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                ...
                                <div style={{
                                    ...
                                    <span style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#818cf8' }}>
                                        Structured Learning
                                    </span>
                                </div>
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                backgroundImage: `
                                    repeating-linear-gradient(rgba(245,158,11,0.055) 0px, rgba(245,158,11,0.055) 1px, transparent 1px, transparent 52px),
                                    repeating-linear-gradient(90deg, rgba(245,158,11,0.055) 0px, rgba(245,158,11,0.055) 1px, transparent 1px, transparent 52px)
                                `,
                                pointerEvents: 'none',
                            }} />
                            ...
                            <div style={{
                                position: 'absolute', right: '16px', top: '4px',
                                fontSize: '200px', fontWeight: 900, lineHeight: 1,
                                color: 'rgba(245,158,11,0.04)', letterSpacing: '-0.06em',
                                userSelect: 'none', pointerEvents: 'none',
                            }}>02</div>
                    ...
                    <div style={{ marginTop: '24px' }}>
                        <div className="res-part-label" style={{ color: '#10b981' }}>Part 03 &nbsp;·&nbsp; The Frequency</div>
                        <div
