                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '12px 8px' }}>
                    {siblings.map((sibId) => {
                        ...
                        return (
                            ...
                            >
                                <span style={{ flexShrink: 0, color: isDone ? '#10b981' : isActive ? '#818cf8' : 'var(--color-muted-text)' }}>
                                    {isDone ? <CheckCircle2 size={15} /> : <Circle size={15} />}
                                </span>
                                <span style={{
                                    fontSize: '0.78rem', fontWeight: isActive ? 600 : 400, lineHeight: 1.35,
                                    color: isActive ? '#818cf8' : 'var(--color-muted-text)',
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            display: 'flex', alignItems: 'center', gap: 6,
                            padding: '8px 16px', borderRadius: 10, fontSize: '0.8rem', fontWeight: 600,
                            background: completed[id] ? 'rgba(16,185,129,0.12)' : 'rgba(99,102,241,0.1)',
                            border: completed[id] ? '1px solid rgba(16,185,129,0.3)' : '1px solid rgba(99,102,241,0.3)',
                            color: completed[id] ? '#10b981' : '#818cf8',
                            cursor: 'pointer',
                            transition: 'all 0.2s',
                        }}
                    >
