...
import { ArrowLeft, Send, MoreVertical, Loader, Edit2, Trash2, X, Check } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-3">
                ...
                {messages.map((message, idx) => {
                    ...
                    return (
                        <div
                            key={message.id}
                            className={`flex ${isOwn ? 'justify-end' : 'justify-start'} message-entrance`}
                            style={{
                                animation: `messageSlideIn 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) ${idx * 0.05}s both`,
                            }}
                        >
                            <div
                                className="relative max-w-xs lg:max-w-md px-4 py-2.5 rounded-2xl group"
                                style={{
                            ...
                            >
                                ...
                                {canActOn && actionMenuId === message.id && (
                                    <div
                                        className="absolute z-10 right-0 top-7 rounded-lg shadow-lg overflow-hidden"
                                        style={{
                                            backgroundColor: 'var(--color-surface)',
                                            border: '1px solid var(--color-border)',
                                            minWidth: '120px',
                                    ...
                                    >
                                        <button
                                            ...
                                            className="w-full px-3 py-2 flex items-center gap-2 text-sm hover:opacity-80"
                                ...
                                {isEditing ? (
                                    <div className="flex flex-col gap-2 min-w-[200px]">
                                        <textarea
                                            ...
                                            className="w-full px-2 py-1 rounded text-sm resize-none focus:outline-none"
                                            style={{
