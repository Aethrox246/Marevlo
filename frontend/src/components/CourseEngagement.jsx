      ...
      {isOwn && hovered && (
        <button
          ...
          style={{
            ...
            borderRadius: 8, color: '#ef4444', opacity: 0.7, transition: 'opacity 0.2s',
...
export default function CourseEngagement({ courseId }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
          ...
          <button
            ...
            onMouseEnter={e => { if (myReaction !== 'like') e.currentTarget.style.background = 'rgba(16,185,129,0.12)'; }}
          ...
          <button
            ...
            onMouseEnter={e => { if (myReaction !== 'dislike') e.currentTarget.style.background = 'rgba(239,68,68,0.1)'; }}
      ...
      >
        {/* Top gradient bar */}
        <div style={{ height: 3, background: 'linear-gradient(90deg, #8b5cf6, #ec4899, #f59e0b)' }} />
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 }}>
                    <span style={{ fontSize: '0.7rem', color: overLimit ? '#ef4444' : 'var(--color-muted-text)', fontWeight: overLimit ? 700 : 400 }}>
                      {token
                        ? `${commentInput.length} / ${MAX_COMMENT_LENGTH}  ·  Ctrl+Enter to post`
                        : <span><span style={{ color: '#8b5cf6', fontWeight: 700 }}>Sign in</span> to join the discussion</span>
                      }
                    </span>
                    <button
                      ...
                      style={{
                        ...
                        boxShadow: (!token || !commentInput.trim() || posting || overLimit)
                          ? 'none' : '0 4px 14px rgba(139,92,246,0.4)',
                        transition: 'all 0.2s',
